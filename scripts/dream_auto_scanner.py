...
def update_meta_s2_article(tests_html_path, is_ru=False):
    ...
    try:
        ...
        embedded = {
            ...
            'ks_p': snapshot['ks_p'],
        'ks_p_lilliefors': snapshot.get('ks_p_lilliefors'),
        'ks_stat_obs': snapshot.get('ks_stat_obs'),
        'ks_boot_mean': snapshot.get('ks_boot_mean'),
        'ks_boot_95': snapshot.get('ks_boot_95'),
